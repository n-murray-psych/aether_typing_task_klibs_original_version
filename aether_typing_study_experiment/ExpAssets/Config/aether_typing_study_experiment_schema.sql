...
CREATE TABLE trials (
    ...
    spatial_target9 text not null, 
    spatial_target10 text not null, 
    spatial_target11 text not null, 
    spatial_target12 text not null, 
    ...
    verbal_target9 text not null, 
    verbal_target10 text not null, 
    verbal_target11 text not null, 
    verbal_target12 text not null
